...
namespace BabelIm {
    ...
    public static class SingleInstance {
        ...
        private class _IpcRemoteService : MarshalByRefObject {
            /// <summary>
            ///   Activate the first instance of the application.
            /// </summary>
            ...
            public void InvokeFirstInstance(IList<string> args) {
                if (Application.Current != null && !Application.Current.Dispatcher.HasShutdownStarted)
                {
                    Application.Current.Dispatcher.BeginInvoke(
                        (Action<object>) ((arg) => SingleInstance._ActivateFirstInstance((IList<string>) arg)), args);
                }
            }

            /// <summary>
            ///   Overrides the default lease lifetime of 5 minutes so that it never expires.
            /// </summary>
